...
import { orgWelcomePath } from '@renderer/lib/org-paths'
...
} from '@renderer/lib/chat-sound'
import { getStoredTorchPreference, setStoredTorchPreference } from '@renderer/lib/scan-torch'
        ...
        <CardContent className="space-y-3 text-sm">
          <div className="flex flex-wrap items-center gap-4 rounded-lg border border-[var(--color-border)] p-3">
            {user?.profilePhotoUrl ? (
              <img src={user.profilePhotoUrl} alt="Your profile" className="h-16 w-16 rounded-full object-cover" />
            ) : (
              <div
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Button asChild variant="outline" size="sm">
              <Link to={orgWelcomePath()}>View full organization details</Link>
            </Button>
          </CardContent>
        </Card>
      )}
      ...
      <Card>
        ...
        <CardContent className="space-y-2 text-sm">
          <div>
            ...
            <p className="font-medium text-gray-900">MyInventory Desktop</p>
          </div>
          {API_BASE_URL && (
            <div>
