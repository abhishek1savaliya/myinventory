...
import { apiFetch, apiFetchJsonWithProgress, ApiRequestError, API_BASE_URL } from '@renderer/lib/api-client'
...
import { ImageCarousel } from '@renderer/components/ui/ImageCarousel'

import { initScanAudio, playScanBeep } from '@renderer/lib/scan-sound'
import { compressImageDataUrl } from '@renderer/lib/compress-image'
import {
  clearCachedBarcodeLookup,
  getCachedBarcodeLookup,
  setCachedBarcodeLookup,
} from '@renderer/lib/scan-barcode-cache'
import { listCameraDevices, preloadBarcodeScanner, startBarcodeScanner } from '@renderer/lib/barcode-scanner'
import { extractProductDetailsFromImage, preloadProductPhotoOcr } from '@renderer/lib/product-photo-ocr'
import {
  applyTorch,
  getStoredTorchPreference,
  setStoredTorchPreference,
  syncTorchWithPreference,
} from '@renderer/lib/scan-torch'
